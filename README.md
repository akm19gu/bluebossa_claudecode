...
| 時刻 | 小節 | コード | 見出し | ステージ |
|---|---|---|---|---|
| 0.00 | カウントイン（無音 2 拍） | — | Post251 | 枠が描かれ、「3」「4」 |
| 1.29 | 1 | Cm7 | Experimental digital jazz | 中央の線が開いて、塗りの鍵盤（ドラムが入る 2.64 秒で Nakam のクレジットに線が引かれる） |
| 3.98 | 2 | Fm7 | Rhythm × Harmony | 鍵盤のグリッサンドでワイプ。この小節の実際のアタックを 16 分グリッドの円周に打点し、内側に 24 分割（四分音）のピッチ円と Fm7 |
| 6.59 | 3 | Dm7♭5 | Beyond convention | **ii** |
| 9.20 | 4 | G7 | ii – V – I | **V**。続いて、I が来るはずの空き枠 |
| 11.80 | 5 | Cm7 | Acoustic × Digital | **I** が 70ms 遅れて傾いて着地（drunk）→ 打ち消し線 → 枠が広がってロゴの絵になり、1・5・2・POST の順に文字が灯る |
| 13.11 | 5（3 拍目） | — | Grooves | アルバム名と M3-2026秋 の情報 |
| 14.41 | 6 | E♭m7 | — | そのまま保持。音声は 14.45 秒からフェードアウトし、15.000 秒で終わる |
